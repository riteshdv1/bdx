...
bdx/1.0.7 win32-x64 node-v14.17.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
* [`sfdx bdx:project:get:apexscriptpath [-i <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxprojectgetapexscriptpath--i-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
* [`sfdx bdx:project:get:releasesteps -f <string> -t <string> [-c] [-d <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxprojectgetreleasesteps--f-string--t-string--c--d-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx bdx:project:get:vlocitypath [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxprojectgetvlocitypath---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx bdx:repo:compare [-s <string>] [-t <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxrepocompare--s-string--t-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx bdx:sync -s <string> [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxsync--s-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
_See code: [lib\commands\bdx\git\compare.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\git\compare.js)_
...
_See code: [lib\commands\bdx\knowledge\articletype\add.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\knowledge\articletype\add.js)_
...
_See code: [lib\commands\bdx\knowledge\articletype\delete.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\knowledge\articletype\delete.js)_
...
_See code: [lib\commands\bdx\org\packages\compare.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\org\packages\compare.js)_
...
_See code: [lib\commands\bdx\org\packages\sync.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\org\packages\sync.js)_

## `sfdx bdx:project:get:apexscriptpath [-i <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Retrieves path of all the anonymous apex scripts

```
USAGE
  $ sfdx bdx:project:get:apexscriptpath [-i <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]
...
_See code: [lib\commands\bdx\project\get\apexscriptpath.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\project\get\apexscriptpath.js)_
...
Exclude package folders to ignore from search list
...
_See code: [lib\commands\bdx\project\get\excludepath.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\project\get\excludepath.js)_
...
Retrieves list of mdapi package folders
...
_See code: [lib\commands\bdx\project\get\mdapipath.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\project\get\mdapipath.js)_
...
Retrieves list of unlocked package folders
...
_See code: [lib\commands\bdx\project\get\packagepath.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\project\get\packagepath.js)_

## `sfdx bdx:project:get:releasesteps -f <string> -t <string> [-c] [-d <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Generates release steps

```
USAGE
  $ sfdx bdx:project:get:releasesteps -f <string> -t <string> [-c] [-d <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]
...
_See code: [lib\commands\bdx\project\get\releasesteps.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\project\get\releasesteps.js)_

## `sfdx bdx:project:get:vlocitypath [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Retrieves list of vlocity deployable folders

```
USAGE
  $ sfdx bdx:project:get:vlocitypath [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]
...
_See code: [lib\commands\bdx\project\get\vlocitypath.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\project\get\vlocitypath.js)_

## `sfdx bdx:repo:compare [-s <string>] [-t <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Retrieves list of commits between two commits

```
USAGE
  $ sfdx bdx:repo:compare [-s <string>] [-t <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]

OPTIONS
  -s, --sourcerepo=sourcerepo                                                       Source repo folder path
  -t, --targetrepo=targetrepo                                                       Target repo folder path
  --json                                                                            format output as json
...
_See code: [lib\commands\bdx\repo\compare.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\repo\compare.js)_

## `sfdx bdx:sync -s <string> [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`
...
_See code: [lib\commands\bdx\sync.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\bdx\sync.js)_
...
_See code: [lib\commands\hello\org.js](https://github.com/codeBase/bdx/blob/v1.0.7/lib\commands\hello\org.js)_
<!-- commandsstop -->
* [`sfdx bdx:git:compare -f <string> -t <string> [-i <string>] [-c] [-s] [-d <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxgitcompare--f-string--t-string--i-string--c--s--d-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx bdx:knowledge:articletype:add -n <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxknowledgearticletypeadd--n-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx bdx:knowledge:articletype:delete -n <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-bdxknowledgearticletypedelete--n-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
